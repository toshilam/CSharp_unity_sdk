...
namespace Xen.Utils
{
	...
	{
		public static Texture2D RotateImage(WebCamTexture originTexture, int angle)
		{
			Texture2D result;
		...
		static Color32[] rotateSquare(Color32[] arr, double phi, WebCamTexture originTexture)
		{
			int x;
			int y;
			int i;
